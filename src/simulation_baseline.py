...
def run_simulation_single(
    ...
    timing_df.to_csv(tables_dir / "single_step_timings_baseline.csv", index=False)
    print("🕒 Wrote step timings to results/tables/single_step_timings_baseline.csv")
...
def run_simulation_multi(
    ...
    # Save step timings
    timing_df = pd.DataFrame(per_p_rows)
    timing_df.to_csv(tables_dir / "multi_step_timings_baseline.csv", index=False)
    print("🕒 Wrote step timings to results/tables/multi_step_timings_baseline.csv")
...
def run_simulation_convergence_rate(
    ...
    timing_df.to_csv(tables_dir / "convergence_step_timings_baseline.csv", index=False)
    print("🕒 Wrote step timings to results/tables/convergence_step_timings_baseline.csv")
...
if __name__ == "__main__":
    ...
    print("🕒 Wrote total simulation timings to results/tables/timings_baseline.csv")
    print(timing_df)